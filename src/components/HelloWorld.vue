  ...
  <v-container>
    ...
    <v-container>
      <v-container>
        <v-row no-gutters>
          <v-col cols="12" sm="6">
            <v-container class="pa-0 ma-0">
              <v-subheader class="white--text">Subject</v-subheader>
            </v-container>
          </v-col>

          <v-col cols="12" sm="6">
            <v-container class="pa-0 ma-0">
              <v-subheader class="white--text">Class</v-subheader>
            </v-container>
          </v-col>
          <!-- <v-col cols="12" sm="3">
            <v-container class="pa-0 ma-0">
        ...
        <v-list class="ma-0 pa-0" dark min-width="100%" flat>
          <v-list-item-group>
            <v-list-item
              class="ma-0 pa-0"
              v-for="item in courses"
              :key="item.id"
              @dblclick="opentopic(item.subject)"
            >
              <v-container class="ma-0 pa-0">
                <v-row no-gutters>
                  ...
                  <v-col cols="12" sm="6">
                    <v-subheader class="caption font-weight-bold">{{ item.class }} {{ item.branch }}</v-subheader>
                  </v-col>
                  <!-- <v-col cols="12" sm="3">
